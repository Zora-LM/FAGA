...
def args():
    ...
    parser.add_argument("--dataset", "-d", type=str, default="WN18RR", help="Dataset string")
    parser.add_argument("--new_dataset", "-nd", type=str, default="WN18RR_v5", help="Dataset string")
    parser.add_argument("--n_roots", "-n", type=int, default="1", help="Number of roots to sample the neighborhood from")
    parser.add_argument("--hops", "-H", type=int, default="3", help="Number of hops to sample the neighborhood")
    parser.add_argument("--max_nodes_per_hop", "-m", type=int, default="2500", help="Number of nodes in the neighborhood")
    parser.add_argument("--hops_test", "-HT", type=int, default="3", help="Number of hops to sample the neighborhood")
    parser.add_argument("--max_nodes_per_hop_test", "-mt", type=int, default="2500", help="Number of nodes in the neighborhood")
    parser.add_argument("--seed", "-s", type=int, default="28", help="Numpy random seed")
